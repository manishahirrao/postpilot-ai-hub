    ...
    <div className="min-h-screen pt-16 bg-background py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4 mt-10">2. How We Use Cookies</h2>
            <p className="text-foreground mb-6">We may set cookies under the following categories:</p>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-medium text-foreground mb-3">a. Essential Cookies</h3>
                <p className="text-gray-700">Enable core website functionality (e.g., account login, Navbar, retaining session identifiers).</p>
                <div className="text-sm text-gray-600">Examples: “session_id” (keeps you logged in while navigating between pages).</div>
              </div>
              <div>
                <h3 className="text-xl font-medium text-foreground mb-3">b. Performance and Analytics Cookies</h3>
              ...
              <div>
                <h3 className="text-xl font-medium text-foreground mb-3">c. Functionality Cookies</h3>
              ...
              <div>
                <h3 className="text-xl font-medium text-foreground mb-3">d. Advertising and Targeting Cookies</h3>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. How to Manage Cookies in Your Browser</h2>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground">If you have any questions about our use of cookies, contact us at:</p>
            <div className="bg-muted/50 p-4 rounded-lg">
              <p className="text-foreground">Email: <a href="mailto:email@example.com" className="text-primary underline">email@example.com</a></p>
